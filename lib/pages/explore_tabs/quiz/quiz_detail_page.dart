    ...
    try {
      if (allCorrect) {
        ...
        if (activityDoc.exists) {
          ...
          rewardDistributionType = activityData['reward_distribution_type'] as String? ?? 'first_come_first_serve';
      ...
      await FirebaseFirestore.instance
        ...
        'isRewarded': allCorrect && rewardDistributionType != 'lucky_draw',
        'score': score,
        'totalQuestions': _questions.length,
        if (allCorrect && rewardDistributionType != 'lucky_draw' && rewardCode != null) 'rewardCode': rewardCode,
