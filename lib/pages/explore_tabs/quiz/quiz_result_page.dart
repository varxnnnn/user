...
class QuizResultPage extends StatelessWidget {
  ...
  String _getRewardDisplayText() {
    ...
    switch (rewardType.toLowerCase()) {
      ...
      case 'coins':
        return "Reward: ${rewardTitle ?? 'Coins'} (${rewardPoints} coins)";
      case 'lucky_draw':
        return "Lucky Draw Participation";
      default:
  ...
  String _getSuccessMessage() {
    ...
    switch (rewardType.toLowerCase()) {
      ...
      case 'coins':
        return "Congratulations! You earned $rewardPoints coins!";
      case 'lucky_draw':
        return "Thank you for participating in the lucky draw! Results will be announced soon. Winners will be notified.";
      default:
